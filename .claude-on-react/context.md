...
├── services/       # api.ts — axios instance + all domain services
...
- Use the existing service layer (`groupService`, `giftIdeaService`, etc.) — don't call axios directly from components
